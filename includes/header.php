...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset_url('icons/favicon.png')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset_url('icons/apple-touch-icon.png')); ?>">
    ...
    $schema = [
        ...
        'additionalProperty' => [
            ...
            ['@type' => 'PropertyValue', 'name' => 'No Onion', 'value' => 'Yes'],
            ['@type' => 'PropertyValue', 'name' => 'No Garlic', 'value' => 'Yes'],
        ],
    ];
    if (has_real_address()) {
